      ...
      <div class="row">
        ...
        <div class="col-8 p-5">
          <div class="card-body">
            ...
            <p class="card-text">2023-05-17</p>
            <p class="card-text">⭐ 7.1</p>
            <p class="card-text-detail">
              돔과 그의 패밀리 앞에 나타난 운명의 적 단테. 과거의 그림자는 돔의 모든 것을 파괴하기 위해 달려온다. 단테에 의해 산산히 흩어진 패밀리들은 모두 목숨을 걸고 맞서야 하는 함정에 빠지고
              마는데...
            </p>
          </div>
        </div>
